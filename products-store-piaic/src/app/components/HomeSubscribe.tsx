    ...
    <section>
        <Wrapper>
            ...
            <div className="absolute font-extrabold text-[7.5rem] leading-[151px] text-gray-200 z-0">Newsletter</div>
                ...
                <form className='z-10'>
                    <input className='border border-[#808080] py-[6px] pl-5 pr-[120px] z-10' type="email" placeholder="Input email address"/>
                    <button className='py-[10px] px-5 ml-[10px] bg-black font-semibold text-[.9rem] leading-4 text-white z-10' type="submit">Get Started</button>
                    </form>
            </div>
        </Wrapper>
    </section>
